...
public class Produto {
    ...
    public String toString() {
        return "Produto{" + "id=" + id + ", nome=" + nome + ", descricao=" + descricao + ", preco=" + preco + ", categoria=" + categoria + ", quantidade=" + quantidade + ", usuario=" + usuario + ", dataHoraCriaco=" + dataHoraCriacao + '}';
    }
