...
import com.jsbtech.gestao_vendas.modelo.dao.CategoriaDao;
import com.jsbtech.gestao_vendas.modelo.dao.ClienteDao;
import com.jsbtech.gestao_vendas.modelo.dao.ProdutoDao;
import com.jsbtech.gestao_vendas.modelo.dao.UsuarioDao;
import com.jsbtech.gestao_vendas.modelo.dao.VendaDao;
...
import com.jsbtech.gestao_vendas.modelo.util.AbstractMouseListener;
import com.jsbtech.gestao_vendas.modelo.util.VendaRegistroTableModel;
import com.jsbtech.gestao_vendas.modelo.util.VendaTableModel;
        ...
        if(this.vendaDetalhes != null) {
            ...
            JOptionPane.showMessageDialog(dashboard, 
                String.format("Detalhes da venda com id: %d \n\n"
                      ...
                      this.vendaDetalhes.get(0).getVenda().getTotalDaVenda(),
